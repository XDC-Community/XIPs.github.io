...
author: Charles Cooper (@charles-cooper), Dan Liu (@gzliudan)
discussions-to: https://www.xdc.dev/gzliudan/xip1898-proposal-add-blockhash-to-defaultblock-methods-i16
status: Draft
type: Standards Track
category (*only required for Standards Track): XRC
created: 2023-03-09
requires (*optional): EIP-234
---
...
Since there is no way to clearly distinguish between a DATA parameter and a QUANTITY parameter, this XIP proposes a new scheme for the block parameter. The following option is additionally allowed:
